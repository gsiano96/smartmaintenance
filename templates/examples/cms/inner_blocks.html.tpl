...
<div class="container">
    ...
    <p>Note:</p>
    <h4>Template uses jQuery for reading  select <strong>data-option-selected</strong> attribute to identify its default values and then for applying <u>selected</u> attribute on its corresponding option</h4>
    jQuery code:
    <pre>
