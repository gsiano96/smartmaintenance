...
<div class="container">
    ...
    <table class="table">
        ...
        <tr>
            <td><button type="button" class="btn btn-warning btn-block btn-sm">Job 1 <i class="fa fa-clock-o"></i></button></td>
            <!-- BEGIN ActivityJob1Parameter -->
            <td><input type="text" readonly></td>
            <!-- END ActivityJob1Parameter -->
        </tr>
     </tbody>
    </table>
    <button type="button" class="btn btn-danger btn-lg btn-block"> Interruption <i class="fa fa-bell"></i></button>
