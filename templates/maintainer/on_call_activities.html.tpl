...
<head>
    ...
    <title>On Call Activities</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        <div class="navbar-header">
            <a href="on_call_activities" class="navbar-brand"> Maintainer</a>
        </div>
...
<div class="container">
    ...
    <table class="table">
        ...
        <tbody>
        <!-- BEGIN OnCallActivitiesRow -->
        <tr>
            <td><a href="on_call_activities_screen?iden={IDData}" >{DescriptionData}</a></td>
            <td>{TimeData}</td>
            <td>{InterrumptibleData}</td>
        </tr>
        <!-- END OnCallActivitiesRow -->
        </tbody>
    </table>
</div>
</body>
