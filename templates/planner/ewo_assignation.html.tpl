...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">Required time{time}</div>
    </div>
    <div class="row">
        <div class="col-sm-3">{Day}</div>
        <div class="col-sm-2">{N°day}</div>
    ...
    <div class="row">
        ...
        <div class="col-md-4" ><input type="submit" value="Send"></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-4">{Skills needed}</div>
    </div>
</div>
