...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-4"><textarea></textarea></div>
        <div class="col-md-4"><div class="it-list-wrapper">
                <ul class="it-list">
                    <li>
                        <a href="#">
    ...
    <div class="row" style="padding: 20px">
        ...
        <div class="col-md-4"> <textarea>Estimated time required</textarea></div>
        <div class="col-md-4"> <input type="submit" value="Forward"></div>
    </div>
