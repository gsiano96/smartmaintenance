...
VALUES ('01', 'Descrizione 2', 'MAKE', 10000, 'kg', 'PRODUCT', '01', 1, 10),
...
INSERT INTO `user` (`id_user`, `id_access_level`, `full_name`, `email`, `password`, `enabled`)
VALUES (1, 100, 'Administrator', 'admin@email.com', '5f4dcc3b5aa765d61d8327deb882cf99', 1),
...
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `stock_store` AS
